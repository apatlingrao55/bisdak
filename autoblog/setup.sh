...
echo "3. Add cron jobs (times in UTC; NZT = UTC+12 in summer, +13 with DST):"
echo "   0 14 * * *    $SCRIPT_DIR/run.sh discover    # 02:00 NZT daily"
echo "   0 21 * * 1-5  $SCRIPT_DIR/run.sh publish     # 09:00 NZT Mon-Fri"
echo "   0 14 * * 0    $SCRIPT_DIR/run.sh keywords    # 02:00 NZT Sun"
echo "   0 21 * * 1    $SCRIPT_DIR/run.sh health      # 09:00 NZT Mon"
